function tally_em(lof_gof_km,lof_gof_hits,hit_anti_hit,dd,fid,fid_str)

[aa.gene,aa.hit,~,aa.km_lof,~,~,~,aa.km_p,aa.J]=textread(fid_str,'%s%s%n%s%s%s%n%n%n','delimiter','\t');
