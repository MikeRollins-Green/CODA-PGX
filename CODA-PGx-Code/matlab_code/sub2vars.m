function g=sub2vars(ss,my_min_syn,my_max_gnom,my_min_revel,my_min_vest,my_max_fathmm,my_min_mpc,my_min_taste,my_min_clinvar,my_min_deogen,my_min_clinpred,my_min_in_domain,my_min_alpha)
