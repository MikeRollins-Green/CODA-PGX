function [J,p]=analyze_em_leapfrog(drugs,clin,x,my_genes,my_drug,my_cancer,min_prop_dose,min_prop_time,max_age)
...
off=strcmp(drugs.drug,my_drug)&strcmp(drugs.cancer_type,my_cancer)&drugs.prop_time>=min_prop_time&drugs.prop_dose>=min_prop_dose&drugs.age_at_diagnosis<=max_age;
