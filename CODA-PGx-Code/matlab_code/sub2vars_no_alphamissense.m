function g=sub2vars_no_alphamissense(ss,my_min_syn,my_max_gnom,my_min_revel,my_min_vest,my_max_fathmm,my_min_mpc,my_min_taste,my_min_clinvar,my_min_deogen,my_min_clinpred,my_min_in_domain)
...
lin_off=ss.gnom<=my_max_gnom&...
    ...
    %ss.alphasense_score>=my_min_alpha&...
